                        ...
                        <li class="nav-item">
                            <a href="#" class="nav-link">
                                ...
                                <span class="__cf_email__"
                                    data-cfemail="553d3039393a15302d34382539307b363a38">[email&#160;protected]</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="#" class="nav-link">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-12 col-md-6 p-3 text-center text-lg-right">
                    <p>© 2021 NEXGEN is Proudly Powered by <a href="https://themeforest.net/user/codingsdev"
...
<div id="sign" class="p-0 modal fade" role="dialog" aria-labelledby="sign" aria-hidden="true">
    <div class="modal-dialog modal-dialog-slideout" role="document">
        <div class="modal-content full">
            ...
            <div class="modal-body">
                <form action="https://nexgen-html.codings.dev/" class="row">
                    <div class="col-12 p-0 align-self-center">
                        <div class="row">
